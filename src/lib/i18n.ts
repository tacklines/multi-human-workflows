...
export const messages: Record<string, string> = {
  ...
  'shell.tab.priority.locked': 'Add a second perspective to unlock priority ranking',
  'shell.tab.breakdown.locked': 'Add a second perspective to unlock breakdown view',
