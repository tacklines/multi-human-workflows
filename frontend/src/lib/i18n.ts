...
export const messagesEn: Record<string, string> = {
  ...
  // ── project-metrics ──
  "workspace.tab.metrics": "Metrics",
  "metrics.title": "Metrics",
  "metrics.tabLabel": "Metrics",
  ...
  "metrics.pendingHigh": "High queue depth",
  "metrics.pendingSubtitle": "awaiting dispatch",
  "metrics.perspective": "By Perspective",
  "metrics.perspectiveCol": "Perspective",
  "metrics.countCol": "Count",
  "metrics.successRateCol": "Success %",
  "metrics.avgDurationCol": "Avg Duration",
  "metrics.model": "By Model",
  "metrics.modelCol": "Model",
  "metrics.costCol": "Cost (USD)",
  "metrics.workspaceStatus": "Workspace Status",
  "metrics.period.1h": "Last hour",
  "metrics.period.24h": "Last 24 hours",
  "metrics.period.7d": "Last 7 days",
  "metrics.period.30d": "Last 30 days",
  "metrics.noData": "No data for this period.",
  "metrics.errorLoad": "Failed to load metrics",
