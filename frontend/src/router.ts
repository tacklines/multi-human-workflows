...
export function initRouter(outlet: HTMLElement): Router {
  ...
  router.setRoutes([
      ...
      action: async (context, commands) => {
        try {
          ...
          return commands.redirect(
            `/orgs/${org.slug}/projects/${(context.params as Record<string, string>).id}`,
          );
        } catch {
          return commands.redirect("/orgs");
        }
    ...
    },
    {
      ...
      action: async (context, commands) => {
        try {
          ...
          return commands.redirect(
            `/orgs/${org.slug}/projects/${params.id}/${params.rest}`,
          );
        } catch {
          return commands.redirect("/orgs");
        }
    ...
    // User settings
    {
      ...
      action: async () => {
        await import("./components/user/user-settings.js");
      },
    },
    // Org routes
    {
      ...
      action: async () => {
        await import("./components/org/org-dashboard.js");
      },
    },
    {
      path: "/orgs/:slug",
    ...
    },
    {
      ...
      action: async () => {
        await import("./components/org/org-settings.js");
      },
    },
    {
      ...
      action: async () => {
        await import("./components/project/project-workspace.js");
      },
    },
    {
    ...
    {
      path: "/orgs/:slug/projects/:id/workspaces/:workspaceId",
      component: "project-workspace",
      action: async () => {
        await import("./components/project/project-workspace.js");
      },
    ...
    // Session routes (unchanged — globally unique codes)
    {
      ...
      action: async () => {
        await import("./components/session/session-lobby.js");
      },
    },
    {
